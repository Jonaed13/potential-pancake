...
func (cm ConfigModal) GetDescription(idx int) string {
	...
	case 1:
		return "Multiplier of entry price to trigger a take profit sell."
	case 2:
		return "Maximum % of wallet balance to allocate per trade."
	case 3:
		return "Maximum number of concurrent open positions."
	case 4:
		return "Additional fee (in SOL) to prioritize transaction processing."
	case 5:
		return "Master switch to enable or disable automated trading."
	default:
		return ""
	}
}
...
func (cm ConfigModal) Render(w, h int) string {
	...
	s += "\n" + StyleHelpText.Render(cm.GetDescription(cm.Selected)) + "\n"
