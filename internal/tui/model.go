...
func (m Model) View() string {
	...
	case ScreenHelp:
		return m.overlay(m.renderDashboard(), m.renderHelp(m.Width, m.Height))
	default:
...
func (f FooterComponent) Render(w int) string {
	...
	switch f.Screen {
	case "dashboard":
		s = RenderHotKey("?", "Help") + " " + RenderHotKey("C", "fg") + " " + RenderHotKey("P", "ause") + " " + RenderHotKey("S", "ell") + " " + RenderHotKey("L", "og") + " " + RenderHotKey("T", "rades") + " " + RenderHotKey("F9", "Clr") + " " + RenderHotKey("Q", "uit")
	case "logs":
